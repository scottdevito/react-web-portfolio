    ...
    <div style={props.visible ? { display: 'block' } : { display: 'none' }}>
      ...
      <div className="education panel panel-default">
        ...
        <div className="panel-body">
          ...
          <p>
            Computer Programming, Internet Programming, Web Development,
            Database Management, Discrete Mathematics, Data Structures, Network
            and Internet Security, Computer Networks, Communication for
            Technical Professions, and Knowledge Management.
          </p>
        </div>
      </div>
    </div>
